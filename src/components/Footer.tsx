        ...
        <div className="grid gap-12 md:grid-cols-5 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white">SAMRA PRIVE</span>
            </div>
            <p className="text-sm leading-relaxed">Your trusted partner in finding luxury homes and investment properties worldwide.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>📧 hello@samraprive.com</li>
              <li>📞 +1 (555) 123-4567</li>
              <li>📍 45 Luxury Ave, NY 10001</li>
          ...
          <div>
            ...
            <form className="flex flex-col gap-2">
              ...
              <button type="submit" className="rounded-lg bg-gradient-to-r from-teal-500 to-teal-600 px-4 py-2 text-sm font-semibold text-white hover:shadow-lg transition">Subscribe</button>
            </form>
          </div>
        </div>
        <div className="border-t border-slate-700 pt-8">
          <div className="grid gap-4 md:grid-cols-2">
            <p className="text-sm">© {new Date().getFullYear()} SAMRA PRIVE. All rights reserved.</p>
